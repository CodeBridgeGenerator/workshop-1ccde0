...
const VehiclesFakerDialogComponent = (props) => {
    ...
    const [cusrtomerNameIds, setcusrtomerNameIds] = useState();
    ...
    const onRun = async () => {
        let fakeData = vehiclesFakerFactory(props.user,fakerCount,cusrtomerNameIds);
